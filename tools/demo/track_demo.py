...
def make_parser():
    ...
    # input data
    parser.add_argument('--video_dir', type=str, default='./data/cloth/demo/images', help='file names') 
...
if __name__ == "__main__":
    ...
    for seq in tqdm(seqs):
        for camera in cameras:
            ...
            images_path = os.path.join(args.video_dir, seq, camera, args.suffix, '*.jpg')
