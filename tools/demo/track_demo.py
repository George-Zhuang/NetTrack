...
def make_parser():
    ...
    # input data
    parser.add_argument('--seq_dir', type=str, default='./data/demo/images', help='file names') 
...
if __name__ == "__main__":
    ...
    for seq in tqdm(seqs):
        ...
        images_path = os.path.join(args.seq_dir, seq, args.suffix, '*.jpg')
        ...
        det_boxes_path = os.path.join(args.det_preds, seq, args.suffix, 'txt/*.txt')
